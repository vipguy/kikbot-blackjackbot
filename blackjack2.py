...
class EchoBot(KikClientCallback):
    ...
    # send the image and the fact
        ...
        if chat_message.body.lower().startswith("ask"):
            ...
            self.client.send_chat_message(chat_message.group_jid, f"AI: {response}")
            ...
            if response.status_jid in ["ki7i2vvrjyn2vatxrnwevw23gao26qytetof2l3zkugu4345z5lq_a@talk.kik.com", # just bot jids
                ...
                if self.get_captcha_status(response.group_jid):
                    ...
                    self.pending_math_problems[response.status_jid] = {
                        "problem": f"Solve the math problem: {num1} + {num2}",
                        "solution": solution
                    }
...
if __name__ == '__main__':
    ...
    if not os.path.isfile(creds_file):
        os.chdir("C:\\\\Users\\alexf\\Desktop\\kik-bot-api-unofficial-new\\examples")
